(function () {
  ...
  const moduleOwnerTasks = [
    ...
    },
    {
      ...
      guide: "使用逻辑：校区运营 → 岗位宣传栏 → 人事管理。校区运营记录教室、卫生、安全检查、值班和异常事项；岗位宣传栏给全员查看负责人、岗位名称和职责说明，程志豪和陈雨晴可拖动调整展示顺序；人事管理维护员工档案、岗位权限、入职转正、培训记录和提成档位。\n试用重点：检查三个模块入口是否清楚，岗位宣传栏是否普通老师能看、管理员能拖动排序和维护，人事资料和权限是否不会暴露给无关账号。\n联动重点：人事权限会影响每个人能看到哪些系统、能新增/编辑/导出哪些数据；校区运营后续会影响排课教室、值班和校区事务安排。"
    },
    {
      key: "ai",
      system: "课堂反馈AI助手",
