  ...
  const usageHelpGuideSections = {
    ...
    学生与家长服务系统: [
      ...
      },
      {
        title: "点名课消怎么做",
        items: [
          "先选日期、时间、老师，系统会自动匹配可点名班级；程老师班课老师可少选一步。",
          "点“带出所选班级名单”或“开始点名”后，学生状态默认都是未点名/空白，老师要逐个手动点。",
      ...
      },
      {
        ...
        items: [
          ...
          "缺勤异常先选日期、时间、老师、班级，只处理这个班级的异常学生，不在全量长表里翻。",
    ...
    校区运营与人事系统: [
      {
        title: "一进来先看三块",
        items: [
          "系统分校区运营、岗位排班、人事管理三块；普通老师主要看校区运营和岗位排班。",
          "岗位排班和校区运营默认是展示功能；编辑入口只给陈雨晴、程志豪等管理员。",
      ...
      },
      {
        title: "岗位排班",
        items: [
          "岗位排班用于展示暑假排班、岗位安排、校区支持和值班信息。",
          "所有老师可查看；陈雨晴和程志豪可点编辑入口修改。",
          "老师查自己排班时先用搜索框搜姓名；管理员修改后要保存并确认列表已更新。"
        ]
      },
      {
        title: "人事管理",
